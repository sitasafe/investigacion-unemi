...
def obtener_explicacion_ia(df_stats, r2):
    """Configura y usa Gemini directamente."""
    # TU CLAVE REAL
    LLAVE_MAESTRA = "AIzaSyC3XWlImuVEFuqo5p0H0FjcKX0n5XmlF1E"
    ...
    try:
        ...
        Explica en 3 párrafos profesionales:
        1. Si la IA ayuda al análisis crítico.
        2. Si actúa como andamiaje o sustituto.
        3. Una breve recomendación para el Dr. Bonisoli.
        """
...
<style>
    ...
    .ia-box {
        ...
        border-left: 5px solid #4285F4; margin: 10px 0; color: #1a73e8;
    }
</style>
...
st.markdown(f"**👨‍🏫 {lang['tutor']}:** Bonisoli Lorenzo PhD.")
...
# (El resto de las pestañas se mantienen igual que tu código original)
with tab1:
